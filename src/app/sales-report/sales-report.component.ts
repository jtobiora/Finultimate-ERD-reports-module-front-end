...
export class SalesReportComponent implements OnInit, AfterViewInit {
  ...
  generateReport(){
    ...
    if(this.reportType === REPORT_TYPE.SALES_SUMMARY){
      processWebservice(this.reportService.generateReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue));

      this.reportService.generateProductReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue)
        .subscribe(
          res => {
    ...
    if(this.reportType === REPORT_TYPE.USER){
      processWebservice(this.reportService.generateUserReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue));

      this.reportService.generateUserProductReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue)
        .subscribe(
          res => {
    ...
    if(this.reportType === REPORT_TYPE.CUSTOMER){
      processWebservice(this.reportService.generateCustomerReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue));

      this.reportService.generateCustomerProductReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue)
        .subscribe(
          res => {
    ...
    if(this.reportType === REPORT_TYPE.OUTLET){
      processWebservice(this.reportService.generateOutletReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue));

      this.reportService.generateOutletProductReport(this.reportGranularity, this.getReportTypeKey(this.reportType), this.measureValue)
        .subscribe(
          res => {
  ...
  navigate(reportType){
    if(reportType === REPORT_TYPE.SALES_SUMMARY){
      this.router.navigate(['/sales-report/summary']);
    }

    if(reportType === REPORT_TYPE.USER){
      this.router.navigate(['/sales-report/user']);
    }

    if(reportType === REPORT_TYPE.CUSTOMER){
      this.router.navigate(['/sales-report/customer']);
    }

    if(reportType === REPORT_TYPE.OUTLET){
      this.router.navigate(['/sales-report/outlet']);
    }
  }
