...
@Component({
  selector: 'app-outlet-summary-cluster',
  templateUrl: './outlet-summary.component.html',
  styleUrls: ['./outlet-summary.component.css']
})
export class OutletSummaryClusterComponent implements OnInit , AfterViewInit {
  ...
  getUserSalesSummary(report){
    // if(this.summary && report['outletName'] === this.outlet) { 
    //   return this.summary;
    // }
